from Const import BOXSIZE, XMARGIN, YMARGIN
...
def leftTopCoordsOfBox(boxx, boxy):  #screen coords
    ...
    left = boxx * BOXSIZE + XMARGIN  #screen coords
    top = boxy * BOXSIZE + YMARGIN  #screen coords
